...
bool usr_msgs__msg__land_mark__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("usr_msgs.msg._land_mark.LandMark", full_classname_dest, 32) == 0);
  }
  usr_msgs__msg__LandMark * ros_message = _ros_message;
  {  // neighbors
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      if (!rosidl_runtime_c__int8__Sequence__init(&(ros_message->neighbors), size)) {
        PyErr_SetString(PyExc_RuntimeError, "unable to create int8__Sequence ros_message");
        PyBuffer_Release(&view);
        Py_DECREF(field);
        return false;
      }
      int8_t * dest = ros_message->neighbors.data;
...
PyObject * usr_msgs__msg__land_mark__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("usr_msgs.msg._land_mark");
  ...
  {  // neighbors
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "neighbors");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->neighbors.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int8_t * src = &(ros_message->neighbors.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->neighbors.size * sizeof(int8_t));
      assert(data != NULL);
