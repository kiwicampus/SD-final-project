...
bool usr_msgs__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("usr_msgs.msg._waypoint.Waypoint", full_classname_dest, 31) == 0);
  }
  usr_msgs__msg__Waypoint * ros_message = _ros_message;
  {  // id
...
PyObject * usr_msgs__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("usr_msgs.msg._waypoint");
